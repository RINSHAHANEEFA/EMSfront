      ...
      <tbody>

       {
        ...
        displayData.map((item,index)=>(
          ...
          <td>
            <Link to={`/view/${item._id}`}><i class="fa-solid fa-eye fs-3 me-2 text-success"></i></Link>
            <Link to={`/edit/${item._id}`}><i class="fa-solid fa-pen fs-3 me-2 text-info"></i></Link>
            <span onClick={()=>removeuser(item._id)}><i class="fa-solid fa-trash fs-3 me-2 text-secondary"></i></span>
          </td>
        </tr>
